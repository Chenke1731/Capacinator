...
- [x] B4 迭代导航页 v1 (b1d2c7e)
- [x] B5 告警+生命周期吸收+守卫改版+全量回归 (ff0da8d~282ce4b, 32/32)
- [x] 后续: D7 client typecheck 落地(b5d641d) · 末两条告警(1a6810d) ·
      测试对齐(21b5238) —— 原会话失联,由接手会话验收补记(2026-09-23):
      typecheck/client 1469+server 2820 全绿; verify:site 修复 2 处碰撞
      (primary-window flex:none 真溢出 33px + tags 铅笔 opacity 假碰撞)后全过
